            ...
            <div className="bg-white rounded-lg p-8 shadow-2xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-end space-x-4">
                        ...
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Send Invitation</button>
                    </div>
                </form>
            </div>
        </div>
...
const UsersPage = () => {
    ...
    const handleAddSeat = () => {
        setSeatLimit(prev => prev + 1);
        alert('Seat added! You can now invite another user.');
    };
    ...
    const handleOpenInviteModal = () => {
        if (users.length < seatLimit) {
            ...
            alert('You have reached your seat limit. Please add more seats.');
        }
    };
        ...
        <div className="bg-gray-50 flex-1 overflow-y-auto">
            ...
            <main className="p-8">
                <div className="flex justify-between items-center mb-4">
                    <p className="text-gray-600">Your account currently has {users.length} out of {seatLimit} user seat(s).</p>
                    <button onClick={handleAddSeat} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg flex items-center">
                        <Icon path="M12 4.5v15m7.5-7.5h-15" className="w-5 h-5 mr-2" />
                        Add Seats
                    </button>
                </div>
                <div className="bg-white rounded-lg shadow-md">
                    ...
                    <div className="p-4 text-center">
                         <button onClick={handleOpenInviteModal} className="text-blue-500 font-semibold hover:underline">
                            + Add User Seat
                        </button>
                    </div>
                </div>
            ...
            <main className="p-8">
                <div className="text-center mb-12">
                    ...
                    <div className="inline-flex bg-gray-200 rounded-lg p-1">
                        <button onClick={() => setPlanType('Small Teams')} className={`px-6 py-2 rounded-lg text-sm font-semibold ${planType === 'Small Teams' ? 'bg-white shadow' : ''}`}>For Small Teams</button>
                        <button onClick={() => setPlanType('Organizations')} className={`px-6 py-2 rounded-lg text-sm font-semibold ${planType === 'Organizations' ? 'bg-white shadow' : ''}`}>For Organizations</button>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" value={contact.name} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="role" className="block text-gray-700 text-sm font-bold mb-2">Role</label>
                            <input type="text" name="role" value={contact.role} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Email</label>
                            <input type="email" name="email" value={contact.email} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="phone" className="block text-gray-700 text-sm font-bold mb-2">Phone</label>
                            <input type="text" name="phone" value={contact.phone} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
                        </div>
                         <div className="mb-4">
                            <label htmlFor="rate" className="block text-gray-700 text-sm font-bold mb-2">Rate</label>
                            <input type="text" name="rate" value={contact.rate} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" />
                        </div>
                        <div className="mb-4 md:col-span-2">
                            <label htmlFor="notes" className="block text-gray-700 text-sm font-bold mb-2">Notes</label>
                            <textarea name="notes" value={contact.notes} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 h-24" />
                        </div>
                    </div>
                    <div className="flex items-center justify-end space-x-4 mt-6">
                        <button type="button" onClick={onClose} className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded">Cancel</button>
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Contact</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <main className="p-8 flex-1 overflow-y-auto">
                    <div className="flex justify-between items-center mb-4">
                        <div>
                            ...
                            <span className="ml-4 text-gray-500">{contacts.length} contacts</span>
                        </div>
                        <div>
                            <button onClick={() => setIsContactModalOpen(true)} className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded-lg mr-2">
                                + New Contact
                            </button>
                    ...
                    <div className="bg-white rounded-lg shadow-md">
                        <table className="w-full text-left">
                         ...
                         <div className="p-4 text-center">
                             <button onClick={() => setIsContactModalOpen(true)} className="text-blue-500 font-semibold hover:underline">
                                + New Contact
                            </button>
